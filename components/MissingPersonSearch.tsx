...
const STR = {
  es: {
    ...
    identifiedSub: 'Registros que reportan una cédula. Agrupados con alta confianza.',
    approxHeading: 'Agrupación aproximada',
    approxSub: 'Sin cédula: agrupamos por nombre, edad, lugar y foto. El agrupamiento se intenta, pero puede no ser perfecto.',
  ...
  en: {
    ...
    identifiedSub: 'Records that report a cédula. Grouped with high confidence.',
    approxHeading: 'Approximate grouping',
    approxSub: 'No national ID: grouped by name, age, place and photo. Grouping is attempted but may not be perfect.',
