...
import { PersonInput, IngestRequest, CoordinationEntityInput, EntityUpsertRequest, toMatchable } from './schemas.ts';
...
t('redactEntity exposes only the public coordination entity shape', () => {
  ...
  assert.deepEqual(Object.keys(out).sort(), [
    'channels', 'description', 'estado', 'id', 'kind', 'lastVerifiedAt', 'lat', 'lng',
